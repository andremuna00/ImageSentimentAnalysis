...
negative_sentiments = [sentiment.cpu().item() for sentiment in sentiments if sentiment == -1]
neutral_sentiments = [sentiment.cpu().item() for sentiment in sentiments if sentiment == 0]
positive_sentiments = [sentiment.cpu().item() for sentiment in sentiments if sentiment == 1]
